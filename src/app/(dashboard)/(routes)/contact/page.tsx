...
const ContactPage = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        fetch("https://formsubmit.co/ajax/YOUREMAILGOESHERE", {
            method: "POST",
            headers: { 
    ...
    return(
        <>
            <Head>
              ...
              <section className="flex flex-col items-center justify-center min-h-screen bg-purple-100 text-purple-400">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col items-center">
                ...
                <button 
                  type="submit" 
                  className="mt-4  bg-orange-500 hover:bg-green-400 text-white py-2 px-6 rounded-full focus:outline-none"
                >
                  Send
                </button>
              </form>
              ...
              <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
                <div className="bg-white rounded-lg shadow-lg p-8">
                  ...
                  <button 
                    ...
                    className="mt-4 bg-orange-500 hover:bg-purple-400 text-white py-2 px-4 rounded-full focus:outline-none"
                  >
                    Close
                  </button>
                </div>
